...
describe('Hotel details', function() {
  ...
  it('should calculate how many rooms are available for a given date', function() {
    const numberOfRooms = hotel.findRoomsAvailable('2020/04/22')
    const numberRooms = hotel.findRoomsAvailable('2025/01/05')
  ...
  it('should calculate total revenue for today\'s date', function() {
    const todaysRevenue = hotel.calculateTodaysRevenue('2020/04/22')
    const nonExistentRevenue = hotel.calculateTodaysRevenue('2025/01/05')
  ...
  it('should calculate percentage of rooms occupied for today\'s date', function() {
    const percentBooked = hotel.calculatePercentBooked('2020/04/22')
    const noBookingsDate = hotel.calculatePercentBooked('2025/01/05')
  ...
  it('should find an array of all bookings for a given user', function() {
    const userBookings = hotel.findUserBookings(11)

    expect(userBookings).to.be.an.instanceOf(Array)
    expect(userBookings.length).to.equal(12)
  });
  it('should calculate total amount a given user has spent on rooms', function() {
    const totalSpending = hotel.calculateUserSpending(11)
